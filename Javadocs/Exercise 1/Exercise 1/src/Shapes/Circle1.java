...
System.out.println("A circle of radius "+ radius + " m has an area of "+ Circle1.area(radius) + " m2");
System.out.println("A circle of radius "+ radius + " m has a circumference of "+ Circle1.circumference(radius) + " m");
scanner.close();
}
} 